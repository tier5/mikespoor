    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                              <div >
                                <br>
                                <a class="btn btn-primary" href="<?php echo BASE_URI.'backend/home-page/add_edit_offer'; ?>"><i class="fa fa-plus">Add New Offer </i></a>
                                <br>
                              </div>
                              <br>
                                <table id="" class="table table-bordered table-striped">
                                    ...
                                    foreach ($offer_list as $offers ) {?>
                                      <tr>
                                          <td><?php echo $cnt;?></td>
                                          <td><?php echo $offers['home_offer_title'];?></td>
                                          <td> <a class="btn btn-primary btn-md" title="Edit" href="<?php echo BASE_URI.'backend/home-page/add_edit_offer/'.$offers['offer_id']; ?>"><i class="fa fa-edit"> Edit</i></a> <a class="btn btn-danger btn-md" title="Delete" id="delete_home_offer" onclick="delete_home_offer(<?php echo $offers['offer_id']; ?>)" ><i class="fa fa-trash"> Delete</i></a></td>
                                      </tr>
        ...
        <script>
         ...
         $(document).ready(function(){
          ...
          /*$('#delete_home_offer').click(function(e){
              e.preventDefault();
              var self = $(this);
              swal({
                  title: 'Are you sure?',
...
*/
          ...
          function delete_home_offer(offer_id)
          {
             swal({
                  title: 'Are you sure?',
                  text: "You won't be able to revert this!",
                ...
                $.ajax({
                url: 'backend/ajax/delete_home_offer',
                type: "post",
