...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	?>
			...
			{
			?>
            <form action="<?php echo BASE_URI.'backend/home_page/addbanner'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			else if($feature=='Edit')
			{
			?>
            <form action="<?php echo BASE_URI.'backend/home_page/editbanner'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			?>
            ...
            <input type="hidden" name="hid_gallery_pdf2" id="hid_gallery_pdf2" value="<?php if(isset($bannerinfo['banner_front_image'])){echo $bannerinfo['banner_front_image'];} ?>" />
           
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Banner Title</label>
                  <input type="text" class="form-control" name="txtTitle" placeholder="Enter Banner Title" value="<?php if(isset($bannerinfo['banner_title'])){echo $bannerinfo['banner_title'];} ?>" required>
                </div>
                <div class="form-group">
                 ...
                 <p class="help-block" style="font-size:12px;"><i>Prefferable Minimum Image Size Should Be 2MB(1280 x 800).</i></p>
                </div>
                <div class="form-group">
               ...
               <!--  <div class="form-group">
                ...
                <!-- <div class="form-group">
                  ...
                  <select id="bble_shape" name="bble_shape" required>
                     ...
                     <option value="oval" <?php if(isset($bannerinfo['banner_comment'])){ if($bannerinfo['banner_comment_shape']=="oval"){ echo "selected"; } }?>>Oval</option>
			...
			?>
                ...
                <button type="submit" class="btn btn-primary" value="new" name="btnAdd">Save and Add New</button>
                 <a class="btn btn-default" href="<?php echo BASE_URI.'backend/home-page'; ?>">Back To List</a>
                  <?php
			}
			else if($feature=='Edit')
			{
