	...
	?>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				if(count($metalist)>0)
				{
					foreach($metalist as $metalistdata)
					{
				?>
                <tr>
                  <td><?php echo $cnt; ?></td>
                  <td><?php echo $metalistdata['page_name']; ?></td>
                  <td><?php echo $metalistdata['meta_title']; ?></td>
                  <td><?php echo $metalistdata['meta_keywords']; ?></td>
                  <td>
                  <a class="btn btn-primary btn-xs" title="Edit" href="<?php echo BASE_URI.'backend/seo-settings/edit/'.$metalistdata['meta_id']; ?>"><i class="fa fa-edit"></i></a>
