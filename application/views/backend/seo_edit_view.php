...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	?>
			...
			{
			?>
            <form action="<?php echo BASE_URI.'backend/seo-settings/editmeta'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			?>
            <input type="hidden" name="txtCid" value="<?php if(isset($metainfo['meta_id'])){echo $metainfo['meta_id'];} ?>"/>
              ...
              <div class="box-footer">
                 ...
                 <a class="btn btn-default" href="<?php echo BASE_URI.'backend/seo-settings'; ?>">Back To List</a>
