              ...
              <div class="col-md-12">
                <div class="box box-primary">
                  ...
                  <form action="<?php echo BASE_URI.'backend/home_page/saveforeend'; ?>" method="post">
                      ...
                      <input type="radio" name="transition_fore" value="200" <?php if($trans=="200" || $trans==200 ){ echo "checked";}?> > 2
                      <input type="radio" name="transition_fore" value="400" <?php if($trans=="400" || $trans==400 ){ echo "checked";}?>> 4
                      <input type="radio" name="transition_fore" value="600" <?php if($trans=="600" || $trans==600 ){ echo "checked";}?>> 6  
