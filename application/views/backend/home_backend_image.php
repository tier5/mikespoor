            ...
            <div class="box box-primary">
                              ...
                              <br>
                                <table id="" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    <?php  $cnt=1;
                                    foreach ($home_background as $info ) {?>
                                      <tr>
                                          <td><?php echo $cnt;?></td>
                                          <td><?php echo $info['background_name'];?></td>
                                          <td><?php echo $info['background_title'];?></td>
                                          <td><?php echo $info['background_image'];?></td>
                                          <td><a class="btn btn-primary" href="<?php echo BASE_URI;?>/backend/home_page/backend_image_edit/<?php echo $info['id']; ?>"><i class="fa fa-edit"> Edit</i></a></td>
                                      </tr>
