...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $bannerinfo['banner_name']; ?>
            ...
            <input type="hidden" name="hid_gallery_pdf1" id="hid_gallery_pdf1" value="<?php if(isset($bannerinfo['banner_image'])){echo $bannerinfo['banner_image'];} ?>" />
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <img src="<?php if(!empty($bannerinfo['banner_image'])){echo BASE_URI.'assets/required/'.$bannerinfo['banner_image'];} ?>" id="profile" width="200" height="80"/>
