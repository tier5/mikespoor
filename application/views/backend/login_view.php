...
<body class="hold-transition login-page" style="background-image:url(<?php echo BASE_URI; ?>/assets/images/a1.jpg); background-repeat:no-repeat;" >
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo BASE_URI; ?>"><b><?php echo $memberinfo['company_name']; ?></b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <form action="<?php echo BASE_URI.'backend/login/loginaccess'; ?>" method="post">
    <?php
