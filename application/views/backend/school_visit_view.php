  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">School Visit Category</li>
      </ol>
    </section>
	...
	?>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td><?php echo $cnt; ?></td>
                  <td><?php echo $bannerlistdata['school_visit_title']; ?></td>
                 
                   <td>
                   <?php
				  if($bannerlistdata['school_visit_featured'])
				  {
					  ?>
                      <a class="btn btn-success btn-xs" title="Change Featured Status" href="<?php echo BASE_URI.'backend/school_visit/changefeatured/'.$bannerlistdata['school_visit_id'].'/'.$bannerlistdata['school_visit_featured']; ?>"><i class="fa fa-star"></i></a>
                      <?php
				  }
				  else
				  {
					  ?>
                      <a class="btn btn-warning btn-xs" title="Change Featured Status" href="<?php echo BASE_URI.'backend/school_visit/changefeatured/'.$bannerlistdata['school_visit_id'].'/'.$bannerlistdata['school_visit_featured']; ?>"><i class="fa fa-star"></i></a>
                      <?php
				  }
				  ?>
                  </td>
				  ...
				  {
					  ?>
                      <a class="btn btn-success btn-xs" title="Change Status" href="<?php echo BASE_URI.'backend/school_visit/changestatus/'.$bannerlistdata['school_visit_id'].'/'.$bannerlistdata['status']; ?>"><i class="fa fa-unlock"></i></a>
                      <?php
				  }
				  else
				  {
					  ?>
                      <a class="btn btn-warning btn-xs" title="Change Status" href="<?php echo BASE_URI.'backend/school_visit/changestatus/'.$bannerlistdata['school_visit_id'].'/'.$bannerlistdata['status']; ?>"><i class="fa fa-lock"></i></a>
                      <?php
				  }
				  ?>
                   </td>
