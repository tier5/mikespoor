...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	?>
			...
			{
			?>
            <form action="<?php echo BASE_URI.'backend/picture_gallery/addbanner'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			else if($feature=='Edit')
			{
			?>
            <form action="<?php echo BASE_URI.'backend/picture_gallery/editbanner'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <select class="form-control select2" name="selCategory" id="selCategory">
                  ...
                  <p class="help-block" style="font-size:12px;"><i><a href="<?php echo BASE_URI.'backend/picture/add'; ?>">Click here</a> to add new category.</i></p>
                </div>
                <div class="form-group">
			...
			?>
                ...
                <button type="submit" class="btn btn-primary" value="new" name="btnAdd">Save and Add New</button>
                 <a class="btn btn-default" href="<?php echo BASE_URI.'backend/picture_gallery'; ?>">Back To List</a>
                  <?php
			}
			else if($feature=='Edit')
			{
