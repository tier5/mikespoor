...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	?>
			...
			{
			?>
            <form action="<?php echo BASE_URI.'backend/gallery/addbanner'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			else if($feature=='Edit')
			{
			?>
            <form action="<?php echo BASE_URI.'backend/gallery/editbanner'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			?>
            ...
            <input type="hidden" name="hid_gallery_pdf1" id="hid_gallery_pdf1" value="<?php if(isset($bannerinfo['gallery_image'])){echo $bannerinfo['gallery_image'];} ?>" />
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <img src="<?php if(isset($bannerinfo['gallery_image'])){echo BASE_URI.'uploads/'.$bannerinfo['gallery_image'];} ?>" id="profile" width="200" height="80"/>
			...
			?>
                ...
                <button type="submit" class="btn btn-primary" value="new" name="btnAdd">Save and Add New</button>
                 <a class="btn btn-default" href="<?php echo BASE_URI.'backend/gallery'; ?>">Back To List</a>
                  <?php
			}
			else if($feature=='Edit')
			{
