                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    <img class="profile-user-img img-responsive img-rounded" src="<?php if(!empty($userinfo['company_logo'])){echo BASE_URI.'uploads/'.$userinfo['company_logo'];} ?>" alt="Company Logo">
                                    <h3 class="profile-username text-center"><?php if(isset($userinfo['company_name'])){echo $userinfo['company_name'];} ?></h3>
                                    <a target="_blank" href="<?php echo BASE_URI; ?>" class="btn btn-primary btn-block"><i class="fa fa-globe"></i> <b>Visit Website</b></a>
                                </div>
                                <!-- /.box-body -->
                            </div>
                            <!-- /.box -->
                        ...
                        <div class="col-md-8">
                            ...
                            <form action="<?php echo BASE_URI.'backend/site-settings/editsite'; ?>" method="post" enctype="multipart/form-data" >
                                <div class="box box-primary">
                                        ...
                                        <div class="tab-content no-padding">
                                            ...
                                            <div class="chart tab-pane active" id="info"><br/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <img src="<?php if(!empty($userinfo['company_logo'])){echo BASE_URI.'uploads/'.$userinfo['company_logo'];} ?>" id="profile" width="200" height="80"/>
                                            ...
                                            <div class="chart tab-pane" id="display"><br/>
                                                <!-- <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="selTimezone">
                                                        ...
                                                        <option value="<?php echo $userinfo['time_zone']; ?>"><?php echo $userinfo['time_zone']; ?>		</option><?php } ?>
                                            ...
                                            <!-- <div class="form-group">
                                                ...
                                                <pre class='prettyprint hide' id='code-heading'>&lt;input type='color' value='#f594d0' /&gt; <input type='color'  class='basic' value='#f594d0'/> </pre>
                                            </div> -->
