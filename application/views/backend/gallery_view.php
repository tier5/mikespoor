  ...
  <div class="content-wrapper">
	...
	?>
            ...
            <div class="box-header">
              <h3 class="box-title">Car's List</h3>

              <div class="box-tools pull-right">
                <a class="btn btn-block btn-primary btn-xs" href="<?php echo BASE_URI.'backend/gallery/add'; ?>"><i class="fa fa-plus"></i> Add New</a>
              </div>
              <!-- /.box-tools -->
            </div>
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td><?php echo $cnt; ?></td>
                  <td><?php echo $bannerlistdata['gallery_title']; ?></td>
                  ...
                  <td>
                  <a class="btn btn-primary btn-xs" title="Edit" href="<?php echo BASE_URI.'backend/gallery/edit/'.$bannerlistdata['gallery_id']; ?>"><i class="fa fa-edit"></i></a>
                  <a class="btn btn-danger btn-xs" title="Delete" onclick="return confirm('Are you sure you want to delete this banner?');" href="<?php echo BASE_URI.'backend/gallery/delete/'.$bannerlistdata['gallery_id']; ?>"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
                <?php
				$cnt=$cnt+1;
